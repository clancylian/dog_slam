...
data_dir = "/home/ywj/save_data/point/" # should end with / 
...
scan_idx_range_to_stack = [0, 750] #[0, len(scan_files) - 1] # if you want a whole map, use [0, len(scan_files)]
node_skip = 1
...
# f = open(data_dir+"odom_poses.txt", 'r')
while True:
    line = f.readline()
    if not line: break
